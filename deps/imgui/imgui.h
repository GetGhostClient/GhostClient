...
namespace ImGui
{
    ...
    // [Ghost Client patch] Syntax colorize hook — set before InputTextMultiline, cleared after.
    typedef void (*ImGuiSyntaxColorizeFunc)(ImDrawList* dl, ImFont* font, float font_size,
                    ImVec2 draw_pos, const char* buf, const char* buf_end);
    IMGUI_API extern ImGuiSyntaxColorizeFunc GhostSyntaxColorize;
